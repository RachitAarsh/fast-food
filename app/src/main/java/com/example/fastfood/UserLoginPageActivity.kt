...
import com.example.fastfood.databinding.ActivityUserLoginPageBinding
...
class UserLoginPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.userLoginPageGoogleButton.setOnClickListener {
            val signInClient = googleSignInClient.signInIntent
            launcher.launch(signInClient)
        }

        binding.userLoginPageButton.setOnClickListener {
            e_mail = binding.userEmail.text.toString().trim()
            passwrd = binding.userPassword.text.toString().trim()
        ...
        binding.userIfSignUp.setOnClickListener {
