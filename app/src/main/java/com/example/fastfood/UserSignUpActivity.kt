...
import com.example.fastfood.databinding.ActivityUserSignUpBinding
...
class UserSignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.userSignUpPageGoogleButton.setOnClickListener {
            val signInClient = googleSignInClient.signInIntent
            launcher.launch(signInClient)
        }
        binding.userSignUpPageButton.setOnClickListener {
        ...
        binding.userIfLogin.setOnClickListener {
